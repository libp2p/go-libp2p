...
// connection.
func (l *listener) wrapConn(qconn quicreuse.QUICConn) (*conn, error) {
...
func (l *listener) wrapConnWithScope(qconn quicreuse.QUICConn, connScope network.ConnManagementScope, remoteMultiaddr ma.Multiaddr) (*conn, error) {
